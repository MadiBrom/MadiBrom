...
* 📫 Reach me at mlb32595@gmail.com
...
* Squish therapy for restless hands  
* Pop release for micro stress  
* Flow lines to pace breath and focus  
* Click delight for small wins  
* Ambient birds to soften the room  
...
* Story submission with title, summary, content, and simple formatting  
* Rich tags for fandoms, characters, genres, and more  
* Bookmarks to save stories for later  
* Comments and reviews for feedback and conversation  
* Search and filters across tags, ratings, and authors  
...
**Core loop**  
* Enter a room  
* Observe the space and listen  
* Interact with an object or two  
* Unlock a small story beat and a new path
...
**Next milestones**  
* Input mapping pass and clean controller  
* Interactable base class with prompts and focus  
* Room loader plus save and load for state  
* First lighting pass and sound pass  
* Tiny vertical slice with one room, two interactions, one story beat
